...
func TestE2E_VPS_001_CompleteVPSLifecycle(t *testing.T) {
	...
	t.Run("Step5_VerifyK3sCluster", func(t *testing.T) {
		result, err := validator.ValidateK3sCluster(vpsInstance)
	...
	t.Run("Step8_VerifyApplication", func(t *testing.T) {
		...
		result, err := validator.ValidateApplicationDeployment(appName, "e2e-test", appURL)
	...
	t.Run("Step9_VerifySSL", func(t *testing.T) {
		result, err := validator.ValidateSSLCertificate(testDomain)
	...
	t.Run("Step10_VerifyVPSHealth", func(t *testing.T) {
		result, err := validator.ValidateVPSHealth(vpsInstance)
	...
	t.Run("Step11_VerifyEndToEndFlow", func(t *testing.T) {
		...
		result, err := validator.ValidateEndToEndFlow("Complete VPS Lifecycle", workflowSteps)
